...
This could be employed to achieve SSO (OAUTH/OIDC and SAML) to a Cloud Identity Provider (e.g., Azure Active Directory, Okta, Auth0) by using an Identity-Aware Proxy, e.g., [Datawiza Access Broker](https://www.datawiza.com/) and [Google IAP](https://cloud.google.com/iap).
...
By using [Datawiza Access Broker](https://www.datawiza.com/), you get a [configuration-based](https://docs.datawiza.com/step-by-step/step1.html) [no-code solution](https://docs.datawiza.com/), following the detail instruction [here](https://docs.datawiza.com/step-by-step/step1.html).
